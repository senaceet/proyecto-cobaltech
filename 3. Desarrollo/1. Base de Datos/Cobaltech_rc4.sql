...
CREATE TABLE Estado_garantia(
	Id_estado_garantia int(2) NOT NULL comment 'Id estado garantía',
...
CREATE TABLE Estado_envio(
	Id_estado_envio int(5) NOT NULL comment 'Id estado envío',
...
CREATE TABLE Pago(
	Id_pago int(10) NOT NULL comment 'Id pago',
	FacturaId_factura int(10) NOT NULL,
...
CREATE TABLE Tipo_documento(
    ...
    Tipodoc varchar(25) NOT NULL comment 'Nombre del tipo de documento',
...
CREATE TABLE Usuario(
    ...
    Doc_Usuario varchar (10) NOT NULL comment 'Documento del Usuario',
    ...
    Telefono char(7) comment 'Teléfono de envío del usuario, opcional',
    Movil char(10) comment 'Teléfono de envío del usuario, opcional',
